...
export default class LevelsScene extends Phaser.Scene {
    ...
    create() {
        ...
        graphics.fillRoundedRect(
            screenCenterX - 450 + offset,
            screenCenterY + offset,
            225,
            10,
            5,
        );
        graphics.fillRoundedRect(
            screenCenterX - 225 + offset,
            screenCenterY + offset,
            225,
            10,
            5,
        ...
        const shadowLevel1 = this.add.circle(
            screenCenterX - 450 + offset,
            screenCenterY + offset,
            75,
            0x000000,
        ...
        const shadowLevel2 = this.add.circle(
            screenCenterX - 225 + offset,
            screenCenterY + offset,
            75,
            0x000000,
        ...
        const shadowLevel3 = this.add.circle(
            screenCenterX + offset,
            screenCenterY + offset,
            75,
            0x000000,
        ...
        const shadowLevel4 = this.add.circle(
            screenCenterX + 225 + offset,
            screenCenterY + offset,
            75,
            0x000000,
        ...
        const shadowLevel5 = this.add.circle(
            screenCenterX + 450 + offset,
            screenCenterY + offset,
            75,
            0x000000,
        ...
        // icon level
        const level1Icon = this.add.image(
            screenCenterX - 450,
            screenCenterY,
            "level1",
        );
        ...
        const level2Icon = this.add.image(
            screenCenterX - 225,
            screenCenterY,
            "level2",
        );
        ...
        const level3Icon = this.add.image(
            screenCenterX,
            screenCenterY,
            "level3",
        );
        ...
        const level4Icon = this.add.image(
            screenCenterX + 225,
            screenCenterY,
            "level4",
        );
        ...
        const level5Icon = this.add.image(
            screenCenterX + 450,
            screenCenterY,
            "level5",
        );
        ...
        // shadow dulu (di belakang, offset dikit)
